...
//        String r1 = "(\\d{3,4}-|\\(\\d{3,4}\\))?\\d{7,8}";
//        while (true) {
//            String line = scanner.nextLine();
//            System.out.println(line.matches(r1));
//        }
...
//            String line = scanner.nextLine();
//            String r2 = "(\\d{17}[\\dxX])";
//            System.out.println(line.matches(r2));
//        }
        ...
        while (true){
            String line = scanner.nextLine();
            String r3 = "[a-zA-Z0-9_]+@[a-zA-Z0-9]+(\\.[a-zA-Z]+)+";
            System.out.println(line.matches(r3));
        }
